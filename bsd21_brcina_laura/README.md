...
---
**Git Commands**
* config: used to get a configuration name. The defined value is displayed.
* init: The command is for creating a new repository. It is a one-time command.
* commit: the command captures a secure version of the project.
* status: returns the status d. a working directories.
* add: this is used to add a change from the working directory and update a specific file.
* log: filter a project and find exactly that one.
* diff: for comparing files etc.
* pull: to download content and update the local repository.
* push:the commits are pushed from the local repository to a remote one.

**Information about the author**
*Laura Brcina, 21 years old. Student in the second semester Business Software Development at Campus02 in Graz*
**Link to GitHub Site**
<https://github.com>
**Link to School Site**
